...
public class AlipayWapSubmit {
	...
	static{
		try{
			if(AlipayConstants.partner == null || AlipayConstants.partner.isEmpty()){
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayWapConfig.sign_type.equals("MD5") ) {
        	mysign = MD5.sign(prestr, AlipayConstants.key, AlipayWapConfig.input_charset);
        }
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
                      + "_input_charset=" + AlipayWapConfig.input_charset + "\" method=\"" + strMethod
                      + "\">");
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
        ...
        request.setUrl(ALIPAY_GATEWAY_NEW+"_input_charset="+AlipayWapConfig.input_charset);
    ...
    public static String getRequestToken(String text) throws Exception {
    	...
    	if (paraText.get("res_data") != null) {
    		...
    		if(AlipayWapConfig.sign_type.equals("0001")) {
    			res_data = RSA.decrypt(res_data, AlipayConstants.key, AlipayWapConfig.input_charset);
    		}
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = "https://mapi.alipay.com/gateway.do?service=query_timestamp&partner=" + AlipayConstants.partner;
